...
var SubTask = function (_Task) {
    ...
    function SubTask(title, parent) {
        ...
        // використувуємо для батьківського конструктора
    ...
    _createClass(SubTask, [{
        ...
        value: function complete() {
            //this.done = true;
            _get(SubTask.prototype.__proto__ || Object.getPrototypeOf(SubTask.prototype), 'complete', this).call(this); //використовуємо для того щоб не писати ще раз this.done = true;
